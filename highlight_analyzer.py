...
- แต่ละ highlight ต้องยาวอย่างน้อย 60 วินาทีและไม่เกิน 90 วินาที
- สำคัญมาก: start_time และ end_time ต้องอยู่ตรงจุดที่ได้ใจความสมบูรณ์ ห้ามตัดประโยคห้วนๆ เด็ดขาด
